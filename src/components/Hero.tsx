        ...
        <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
                ...
                >
                    ...
                    <a href="mailto:ayushk0520@gmail.com" className="group flex items-center gap-2 px-5 sm:px-6 py-2.5 sm:py-3 bg-accent text-accent-contrast rounded-full text-sm sm:text-base font-medium hover:bg-accent-light hover:shadow-[0_0_20px_var(--accent-glow)] transition-all">
                        <Mail size={18} />
                        <span>Email Me</span>
                    </a>
                </motion.div>
